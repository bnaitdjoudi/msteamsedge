...
export interface ITestSkilsTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITestSkilsTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of Test skils remove page
 */
export class TestSkilsTabRemove  extends TeamsBaseComponent<ITestSkilsTabRemoveProps, ITestSkilsTabRemoveState> {
